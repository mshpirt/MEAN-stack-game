...
angular.module('MainCtrl', ['sessionService']).controller('MainController', function($scope, sessionData) {
    ...
    $scope.tagline = 'This line generated by MainCtrl.js. This page retrieves the express session generated by visitng the site. If a name is entered in New Game, it is associated with the session and remembered.';
